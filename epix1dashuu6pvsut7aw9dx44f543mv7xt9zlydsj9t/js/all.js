  ...
  PageFiles = (function (superClass) {
    ...
    PageFiles.prototype.renderTotalbar = function () {
      ...
      return h("div#PageFilesDashboard", {
        ...
        h("div.totalbar-edit", [
          h("span.title", _("Optional files limit:")), h("input", {
            type: "text",
            value: this.limit,
        ...
        }, _("Used: ") + (Text.formatSize(this.optional_stats.used)) + " / " + (Text.formatSize(limit)) + " (" + (Math.round(percent_optional_downloaded)) + "%)", h("div.icon-arrow-down")), this.menu_totalbar.render(), h("div.totalbar", {
    ...
    PageFiles.prototype.renderSelectbar = function () {
      return h("div.selectbar", {
        ...
        _("Selected:"), h("span.info", [h("span.num", this.selected_files_num + _(" files")), h("span.size", "(" + (Text.formatSize(this.selected_files_size)) + ")")]), h("div.actions", [
            ...
            return function (file) {
              ...
              return h("div.tr", {
                ...
                h("div.td.pre", h("a.checkbox-outer", {
                  ...
                  exitAnimation: Animation.slideUpInout,
                  enterAnimation: Animation.slideDown
                }, _("Pinned")) : void 0), _this.mode === "bigfiles" ? h("div.td.status", {
                  classes: {
...
(function () {
  ...
  Dashboard = (function (superClass) {
    ...
    Dashboard.prototype.handleEnableAlwaysTorClick = function () {
      return Page.cmd("configSet", ["tor", "always"], (function (_this) {
        return function (res) {
          ...
          return Page.cmd("wrapperConfirm", ["Restart EpixNet client?", "Restart now"], function (res) {
            if (res) {
    ...
    Dashboard.prototype.handleWarningsClick = function () {
      ...
      this.menu_warnings.items.push([
        "Restart EpixNet client", (function (_this) {
          return function () {
            return Page.cmd("serverShutdown", {
              restart: true
            });
...
(function () {
  ...
  FeedList = (function (superClass) {
    ...
    FeedList.prototype.renderDiscoverSite = function (cssClass, address, title, description, comingSoon) {
      if (comingSoon) {
    ...
    FeedList.prototype.toggleUtilitySection = function () {
    ...
    FeedList.prototype.renderWelcome = function () {
      ...
      return h("div.welcome", [
        ...
        h("div.sites", [
          this.renderDiscoverSite("site-zerotalk", "epix1talk58lw26c0cyrtuu8axptne2p6zf33s7xxwu", "Epix Talk", "Decentralized forum"),
          this.renderDiscoverSite("site-zeroblog", "epix18l0gy59ka9ka89wm9mwsspfmkcv9tvf7g0cs6f", "Epix Blog", "Decentralized microblogging"),
          this.renderDiscoverSite("site-epixpost", "epix1p0stmcza0xjkvv0vnjlk0ypr7xsunt4lxkhgcm", "Epix Post", "Decentralized social network"),
          this.renderDiscoverSite("site-epixpulse", "epix1pulseg340d7ky6h59v94r0c3a99ysdxwf25ypc", "Epix Pulse", "Decentralized encrypted mailing"),
          this.renderDiscoverSite("site-zerosites", "epix1searchd8hcnyfacvklmszzxwx9ptnf5rde04xf", "Epix Sites", "Decentralized site discovery"),
          this.renderDiscoverSite("site-marketplace", null, "Marketplace", "Decentralized marketplace", true)
        ]),
...
(function () {
  ...
  ConsoleList = (function (superClass) {
    extend(ConsoleList, superClass);

    function ConsoleList() {
      this.show = bind(this.show, this);
      this.render = bind(this.render, this);
      this.renderLogs = bind(this.renderLogs, this);
      this.storeNode = bind(this.storeNode, this);
      this.afterUpdate = bind(this.afterUpdate, this);
      this.handleHideClick = bind(this.handleHideClick, this);
      this.handleRefreshClick = bind(this.handleRefreshClick, this);
      this.update = bind(this.update, this);
      this.logs = null;
      this.visible = false;
      this.max_height = 0;
    ...
    ConsoleList.prototype.update = function () {
      this.need_update = false;
      ...
      Page.cmd("serverErrors", {}, (function (_this) {
        return function (server_errors) {
          ...
          _this.logs.reverse(); // Show newest first
          if (!_this.max_height) {
            _this.max_height = 100;
          }
          _this.updated = true;
    ...
    ConsoleList.prototype.handleHideClick = function () {
      this.visible = false;
      this.max_height = 0;
      Page.projector.scheduleRender();
      return false;
    ...
    ConsoleList.prototype.handleRefreshClick = function () {
      this.need_update = true;
      Page.projector.scheduleRender();
      return false;
    };

    ConsoleList.prototype.afterUpdate = function () {
      this.updated = false;
      if (this.node && this.visible) {
        this.max_height = this.node.offsetHeight + 100;
        return Page.projector.scheduleRender();
    ...
    ConsoleList.prototype.storeNode = function (node) {
      return this.node = node;
    };

    ConsoleList.prototype.renderLogs = function () {
      return h("div.logs", [
        h("div.log.log-head", [
    ...
    ConsoleList.prototype.render = function () {
      if (this.need_update) {
        this.update();
      }
      if (!this.logs) {
    ...
    ConsoleList.prototype.show = function () {
      this.visible = true;
      this.need_update = true;
      return Page.projector.scheduleRender();
    };
  ...
  Site = (function (superClass) {
    ...
    Site.prototype.handleDeleteClick = function () {
      if (this.row.settings.own) {
        Page.cmd("wrapperConfirm", ["You can delete your site using the site's sidebar.", ["Open site"]], (function (_this) {
          return function (confirmed) {
            if (confirmed) {
              return window.top.location = _this.getHref() + "#EpixNet:OpenSidebar";
            }
          };
        })(this));
      } else {
    ...
    Site.prototype.handleHelpsClick = function (e) {
      ...
      this.menu_helps.items.push([
        _("Help distribute all new files"), this.handleHelpAllClick, ((function (_this) {
          return function () {
...
(function () {
  ...
  Head = (function (superClass) {
    ...
    function Head() {
      ...
      this.handleShutdownEpixNetClick = bind(this.handleShutdownEpixNetClick, this);
      this.handleUpdateEpixNetClick = bind(this.handleUpdateEpixNetClick, this);
      ...
      this.handleConsoleClick = bind(this.handleConsoleClick, this);
    ...
    Head.prototype.renderMenuLanguage = function () {
      var lang, langs, ref;
      langs = ["ar", "da", "de", "en", "es", "fa", "fr", "hu", "it", "nl", "pl", "pt", "pt-br", "ru", "sk", "tr", "uk", "zh", "zh-tw", "jp", "sl", "kr"];
      if (Page.server_info.language && Page.server_info.language.length >= 2 && (ref = Page.server_info.language, indexOf.call(langs, ref) < 0)) {
        langs.push(Page.server_info.language);
      }
      return h("div.menu-radio", h("div", _("Language: ")), (function () {
        var i, len, results;
        results = [];
    ...
    Head.prototype.renderMenuTheme = function () {
      ...
      return h("div.menu-radio.menu-themes", h("div", _("Theme: ")), (function () {
        var i, len, results;
        results = [];
    ...
    Head.prototype.handleSettingsClick = function () {
      ...
      this.menu_settings.items.push([
        _("Order sites by peers"), ((function (_this) {
          return function () {
      ...
      this.menu_settings.items.push([
        _("Order sites by update time"), ((function (_this) {
          return function () {
      ...
      this.menu_settings.items.push([
        _("Order sites by add time"), ((function (_this) {
          return function () {
      ...
      this.menu_settings.items.push([
        _("Order sites by size"), ((function (_this) {
          return function () {
      ...
      if (Page.server_info.plugins.indexOf("Stats") >= 0) {
        this.menu_settings.items.push([[h("div.icon-gear.emoji", ""), "Stats"], "/Stats"]);
      }
      this.menu_settings.items.push(["---"]);
    ...
    Head.prototype.handleConsoleClick = function () {
      Page.projector.replace($("#ConsoleList"), Page.console_list.render);
      return Page.console_list.show();
    };

    Head.prototype.handleUpdateEpixNetClick = function () {
      return false;
    };

    Head.prototype.handleShutdownEpixNetClick = function () {
      return Page.cmd("wrapperConfirm", ["Are you sure?", "Shut down EpixNet"], (function (_this) {
        return function () {
          return Page.cmd("serverShutdown");
        };
      })(this));
...
(function () {
  ...
  EpixDash = (function (superClass) {
    extend(EpixDash, superClass);
    ...
    function EpixDash() {
      ...
      return EpixDash.__super__.constructor.apply(this, arguments);
    }

    EpixDash.prototype.init = function () {
      this.params = {};
      this.site_info = null;
    ...
    EpixDash.prototype.addRenderer = function (node, renderer) {
      this.projector.replace(node, renderer);
      return this.renderers.push(renderer);
    };

    EpixDash.prototype.detachRenderers = function () {
    ...
    EpixDash.prototype.setProjectorMode = function (mode) {
    ...
    EpixDash.prototype.createProjector = function () {
      var url;
    ...
    EpixDash.prototype.route = function (query) {
    ...
    EpixDash.prototype.createUrl = function (key, val) {
      var params, vals;
    ...
    EpixDash.prototype.setUrl = function (url, mode) {
      if (mode == null) {
        mode = "replace";
      }
      url = url.replace(/.*?\?/, "");
    ...
    EpixDash.prototype.handleLinkClick = function (e) {
      if (e.which === 2) {
        return true;
      } else {
    ...
    EpixDash.prototype.loadSettings = function () {
    ...
    EpixDash.prototype.loadLocalStorage = function () {
    ...
    EpixDash.prototype.saveSettings = function (cb) {
      if (this.settings) {
    ...
    EpixDash.prototype.onOpenWebsocket = function (e) {
      this.reloadServerInfo();
      this.reloadServerErrors();
      return this.reloadSiteInfo();
    };

    EpixDash.prototype.reloadSiteInfo = function () {
    ...
    EpixDash.prototype.reloadServerInfo = function (cb) {
    ...
    EpixDash.prototype.reloadServerErrors = function (cb) {
    ...
    EpixDash.prototype.reloadAnnouncerInfo = function (cb) {
    ...
    EpixDash.prototype.reloadAnnouncerStats = function (cb) {
    ...
    EpixDash.prototype.onRequest = function (cmd, params) {
      if (cmd === "setSiteInfo") {
    ...
    EpixDash.prototype.setSiteInfo = function (site_info) {
    ...
    EpixDash.prototype.setServerInfo = function (server_info) {
      var ref;
    ...
    EpixDash.prototype.setServerErrors = function (server_errors) {
      var date_added, i, len, level, message, ref;
      this.server_errors = [];
      for (i = 0, len = server_errors.length; i < len; i++) {
        ref = server_errors[i], date_added = ref[0], level = ref[1], message = ref[2];
    ...
    EpixDash.prototype.setAnnouncerInfo = function (announcer_info) {
      this.announcer_info = announcer_info.stats;
      return this.projector.scheduleRender();
    };

    EpixDash.prototype.returnFalse = function () {
      return false;
    };

    EpixDash.prototype.updateEpixNet = function () {
